...
##
INTENT="Looking at range no further than 10x source depth."
...
EPIXYZ=0,0,0                  #
STAXYZ=35.356,35.356,0        # Station 'A', 50 km to the NE; Pg azimuth
STBXYZ=50,0,0                 # Station 'B', 50 km to the East; Lg azimuth
STCXYZ=46.194,-19.135,0       # Station 'C', 50 km to the ESE; mixed Pg/Lg
...
GATHER=0.0211,2.0             # Terminal gather radius, in kilometers.
R0=0.5263                     # Range of first receiver in array
...
produce_ttcurves() {  # $1:     station code
  ...
  octave -qf <<EOF
    ...
    annotate_array([6.40,3.63],{"Pg","Lg"},46); # (mark phase velocities)
