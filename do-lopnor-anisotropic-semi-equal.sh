...
##
##  This DO-SCRIPT exercises a near-equal anisotropic correlation-length
##  override with the LOP NOR cylinder model.
##

## One-liner description: (Keep this BRIEF.)
##
INTENT="Example Lop Nor simulation with semi-equal anisotropic correlation lengths."
CAMPAIGN="Semi-equal anisotropic comparison example"
...
# to it. The vertical value is 1 m smaller than the horizontal value.
ADDITIONAL="--scatter-horizontal=1.25 --scatter-vertical=1.249"
#
#   Event Parameters:
#
